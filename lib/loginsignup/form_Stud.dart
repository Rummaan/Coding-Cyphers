...
class StudDetails extends StatefulWidget {
  @override
  StudDetailsState createState() {
    return StudDetailsState();
  }
}

class StudDetailsState extends State<StudDetails> {
  ...
  void signup() async {
    if (_formKey.currentState.validate()) {
      ...
      try {
        FirebaseFirestore.instance.collection('StudentDetails').add(
            {'name': _fname + ' ' + _lname, 'email': _email, 'rollno': 'null'});
